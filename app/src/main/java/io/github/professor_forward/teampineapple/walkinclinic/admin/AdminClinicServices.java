...
import io.github.professor_forward.teampineapple.walkinclinic.databinding.AdminClinicServiceListBinding;
import io.github.professor_forward.teampineapple.walkinclinic.repo.ClinicService;
import io.reactivex.Single;
import io.reactivex.android.schedulers.AndroidSchedulers;

public class AdminClinicServices extends Fragment {
    private final int DISPLAY_ALL_ON_DELETE_THRESHOLD = 5;

    private ActionMode actionMode;
    private AdminClinicServicesViewModel model;
    private AdminClinicServiceListBinding binding;
    private final AdminClinicServicesAdapter adapter = new AdminClinicServicesAdapter();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.admin_clinic_service_list, container, false);
        View view = binding.getRoot();
        list = view.findViewById(R.id.adminClinicServiceList);
        return view;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        model = ViewModelProviders.of(this).get(AdminClinicServicesViewModel.class);
        binding.setVm(model);
    ...
    private Single<Boolean> deleteServices(Iterable<ClinicService> services) {
        ...
        return promptToDeleteUsers(message)
                .flatMap(response -> {
                    ...
                    return myApplication.getRepo().clinicServices().delete(services)
